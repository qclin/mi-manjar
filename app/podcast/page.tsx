...
export default function Page() {
  ...
  const updateCurrentSequence = () => {
    ...
    <div className="relative">
        ...
        {subtitles.map(({text, start, sequence}) => {
          return (
            <button
              ...
              className={clsx({"bg-rose-300 rounded text-white": currentSequence === sequence},  "appearance-none text-justify")}
        ...
        <audio ref={audioRef} onTimeUpdate={updateCurrentSequence} controls src="/media/audio/Son estas lágrimas mi manjar.mp3" className="w-9/12 my-6 fixed bottom-5"></audio>
        </div>
        );
  }